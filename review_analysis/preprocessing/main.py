...
from review_analysis.preprocessing.enuri_processor import EnuriProcessor
...
PREPROCESS_CLASSES: Dict[str, Type[BaseDataProcessor]] = {
    ...
    "reviews_Lotteon": LotteonProcessor,
    "reviews_Enuri": EnuriProcessor,
    "reviews_emart": EmartProcessor,
